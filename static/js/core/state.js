(function (FP) {
  ...
  FP.SHORTCUTS = [
    ...
    { keys: "F5", when: "Ticket", action: "Cambiar al siguiente ticket abierto" },
    { keys: "F4 / F6", when: "Ticket", action: "Dejar ticket pendiente y crear uno nuevo" },
    { keys: "Supr", when: "Ticket", action: "Eliminar linea seleccionada" },
