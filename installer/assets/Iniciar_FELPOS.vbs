...
' TEMP SIN espacios: usuarios Windows con espacios rompen PyInstaller LoadLibrary.
Option Explicit
...
If Not fso.FolderExists(tmpDir) Then
  MsgBox "No se pudo crear carpeta temporal:" & vbCrLf & tmpDir & vbCrLf & vbCrLf & _
         "Ejecuta Reparar_instalacion.bat como administrador.", vbCritical, "FEL POS"
  WScript.Quit 1
End If
...
Call CleanMeiFolders(shell.ExpandEnvironmentStrings("%ProgramData%") & "\FELPOS\runtime-tmp")
